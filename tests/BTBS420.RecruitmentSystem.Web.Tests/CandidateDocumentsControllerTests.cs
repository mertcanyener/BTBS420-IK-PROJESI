...
public sealed class CandidateDocumentsControllerTests : IClassFixture<TestWebApplicationFactory>
{
    private readonly TestWebApplicationFactory _factory;

    public CandidateDocumentsControllerTests(TestWebApplicationFactory factory)
    {
        _factory = factory;
    }
    ...
    public async Task KorumaliUc_AnonimKullaniciyiReddeder()
    {
        ...
        using var request = new HttpRequestMessage(HttpMethod.Get, "/CandidateDocuments");
    ...
    {
        using var client = CreateClient();
        using var request = new HttpRequestMessage(HttpMethod.Post, "/CandidateDocuments/Delete/1");
    ...
    {
        var controllerType = typeof(CandidateDocumentsController);
    ...
    [Theory]
    [InlineData(nameof(CandidateDocumentsController.Create))]
    [InlineData(nameof(CandidateDocumentsController.Delete))]
