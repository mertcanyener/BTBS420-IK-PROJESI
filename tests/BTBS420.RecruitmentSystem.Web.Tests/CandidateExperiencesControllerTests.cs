...
public sealed class CandidateExperiencesControllerTests : IClassFixture<TestWebApplicationFactory>
{
    private readonly TestWebApplicationFactory _factory;

    public CandidateExperiencesControllerTests(TestWebApplicationFactory factory)
    {
        _factory = factory;
    }
    ...
    public async Task KorumaliUc_AnonimKullaniciyiReddeder()
    {
        ...
        using var request = new HttpRequestMessage(HttpMethod.Get, "/CandidateExperiences");
    ...
    {
        var controllerType = typeof(CandidateExperiencesController);
    ...
    [Theory]
    [InlineData(nameof(CandidateExperiencesController.Create))]
    [InlineData(nameof(CandidateExperiencesController.Edit))]
    [InlineData(nameof(CandidateExperiencesController.Delete))]
